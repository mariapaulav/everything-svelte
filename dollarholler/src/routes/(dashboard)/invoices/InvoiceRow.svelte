...
>
  ...
  <div class="text-base lg:text-lg font-bold clientName">{invoice.client.name}</div>
  <div class="text-sm lg:text-lg font-bold font-mono amount text-right">$504.00</div>
